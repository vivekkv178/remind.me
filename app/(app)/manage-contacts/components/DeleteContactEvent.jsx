...
const DeleteContactEvent = () => {
  ...
  return (
    <Dialog
      open={contactsState?.deleteContactEvent}
      onOpenChange={() =>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            <span className="ml-1 font-bold text-black">
              {contactsState?.deleteContactEvent?.event_name}
            </span>
            ?
          </DialogDescription>
        </DialogHeader>
        <DialogFooter>
          ...
          <Button
            ...
            variant="destructive"
            onClick={() =>
              contactsState?.deleteContactEventHandler(
                contactsState?.deleteContactEvent
              )
            }
          >
